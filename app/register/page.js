...
//               <div key={field}>
//                 <label htmlFor={field} className="sr-only">{field === 'confirmPassword' ? 'Confirm Password' : field}</label>
//                 <input
//                   id={field}
//                   name={field}
...
//                   placeholder={field === 'confirmPassword' ? 'Confirm Password' : field}
...
//     try {
//       setLoading(true);
//       const { confirmPassword, ...userData } = formData; // Hapus confirmPassword sebelum mengirim
//       await register(userData); // Kirim hanya username dan password
//       setSuccess('Registration successful! Redirecting to login...');
//       setTimeout(() => router.push('/login'), 2000);
//     } catch (err) {
//       setError(err.message || 'Registration failed. Please try again.');
